...
<body class="app header-fixed sidebar-fixed aside-menu-fixed sidebar-lg-show">
    ...
    <ul class="nav navbar-nav d-md-down-none">
      ...
      <li class="nav-item px-3">
          <a class="nav-link" href="#">Relatórios Gerais</a>
      </li>
      <li class="nav-item px-3">
...
<li class="nav-item dropdown">
  <a class="nav-link" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
    <img class="img-avatar" src="img/profile.png" alt="admin@bootstrapmaster.com">
</a>
...
<li class="nav-item nav-dropdown">
  <a class="nav-link nav-dropdown-toggle" href="#">
    ...
    <ul class="nav-dropdown-items">
        <li class="nav-item">
          <a class="nav-link" href="{{ route('login') }}" target="_top">
            <i class="nav-icon icon-star"></i> Login</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="{{ route('register') }}" target="_top">
...
<div class="ml-auto">
    <span>Criado por Pablo Castaldelli</span>
</div>
</footer>
